...
public class PermissionsUtil {
     ...
     * @param perms               a set of permissions to be requested.
     */
    private static void requestPermissions(final Object object, String rationale, int snackbarActionResId,
     ...
     */
    private static boolean permissionPermanentlyDenied(Object object, String deniedPermission) {
    ...
    public static void goSettings2Permissions(final Object object, String rationale, String snackbarAction, final int requestCode) {
        ...
        Snackbar.make(activity.findViewById(android.R.id.content), rationale, Snackbar.LENGTH_INDEFINITE)
